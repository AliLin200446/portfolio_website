...
function Row({
  ...
  return (
    <div className="grid gap-1 py-2 sm:grid-cols-[9rem_1fr] sm:gap-6">
      <dt className="font-mono text-[13px] uppercase tracking-widest text-bronze-text">
        {label}
      </dt>
      <dd
        className={
      ...
      <section className="py-16">
        ...
        <div className="mt-10 pt-2">
          ...
          <p className={`${PROSE} mt-5`}>
            ...
            medium-format digital and film. That&rsquo;s not a side note. It&rsquo;s why I calibrate a film emulator against my own
